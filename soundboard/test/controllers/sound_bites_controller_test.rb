...
class SoundBitesControllerTest < ActionController::TestCase
  ...
  test "should create sound_bite" do
    assert_difference('SoundBite.count') do
      post :create, sound_bite: { audiofile: @sound_bite.audiofile, lengh: @sound_bite.lengh, title: @sound_bite.title, transcript: @sound_bite.transcript }
    end
  ...
  test "should update sound_bite" do
    patch :update, id: @sound_bite, sound_bite: { audiofile: @sound_bite.audiofile, lengh: @sound_bite.lengh, title: @sound_bite.title, transcript: @sound_bite.transcript }
    assert_redirected_to sound_bite_path(assigns(:sound_bite))
  end
